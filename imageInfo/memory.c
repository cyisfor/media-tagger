 ...
 * Note: trying to make a block of data and realloc it as more is malloc'd to it fails
 * because previous data malloc'd will become invalid when the entire block is realloc'd
 */
